...
<html lang="en">
  ...
  <body>
    ...
    <div style="position:relative;padding:30px 15px;color:#cdbfe3;text-align:left;text-shadow:0 1px 0 rgba(0,0,0,.1);background-color:#6f5499;">
	<h1>Public Verses</h1>
	<p>You can send a join request to any cause you like</p>
	</div>
	<br>
...
<div class="row">
  <div class="col-sm-4 col-md-2">
    <div class="thumbnail">
      <img src="img/1.jpg" style="width: 300px; height: 300px;" alt="...">
      <div class="caption">
        <h3>Thumbnail label</h3>
        <p>This is details and details......</p>
