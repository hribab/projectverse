...
$disqus_vars = array();
$disqus_vars['user_api_key'] = "PCI1V6gJ1XB6un7TJn2xXRREpvoSg2tCVeoJFbFus1HvOBsYgB4TTJedp4Y953Jm";
$disqus_vars['forum_id'] = "xxxxxxx";
$disqus_vars['since'] = date("Y-m-d\TH:i", mktime(0, 0, 0, date("01")-1, date("01"),   date("2014")));
